...
This project aims to build a predictive model which identifies the likelihood of a borrower defaulting on a loan. By analysing historical financial and demographic data, the model helps financial institutions make informed lending decisions and reduce credit risk.
